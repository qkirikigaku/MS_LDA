...
def main():
    ...
    if(data_type == 1):
        input_file = 'result/data' + str(data_type) + '_o' + threshold \
    ...
    matching_file = 'result/data' + str(data_type) + '_o' + threshold + '_' \
    ...
    while(i < K*2-1):
        ...
        j += 1
    matching.close()
    df_file = 'result/data' + str(data_type) + '_o' + threshold + '_' \
