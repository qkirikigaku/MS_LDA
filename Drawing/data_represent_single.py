...
def main():
    ...
    if(args[1] == '1'):
        ...
        input_file = 'result/data' + args[1] + '_o' + args[3] \
            + '_' + args[4] + '/figure/' + args[2] + '/k' + topic + '.txt'
    ...
    while(i_ex < 96):
        ...
        while(count_ex != 4):
            for k_ex in range(K):
                for l_ex in range(4):
                    p_ex_copy[k_ex, i_ex+4*count_ex +
                              l_ex] = p_ex[k_ex, j_ex+l_ex]
            j_ex += 24
            count_ex += 1
        i_ex += 16
    ...
    while(i_co < 96):
        ...
        while(count_co != 4):
            for k_co in range(30):
                for l_co in range(4):
                    p_co_copy[k_co, i_co+4*count_co +
                              l_co] = p_co[k_co, j_co+l_co]
            j_co += 24
            count_co += 1
        i_co += 16
    ...
    matching_file = "result/data" + args[1] + '_o' + args[3] + '_' + args[4] \
        + '/figure/' + args[2] + "/matching.txt"
    ...
    while(i < K*2-1):
        ...
        j += 1
    matching.close()
    df_file = "result/data" + args[1] + '_o' + args[3] + '_' + args[4] \
        + '/figure/' + args[2] + "/df.csv"
    ...
    for i in range(0, K*2, 2):
        ...
        name = 'result/data' + args[1] + '_o' + args[3] + '_' + args[4] \
            + '/figure/' + args[2] + '/predicted_' + str((i+1)//2 + 1) + '.png'
