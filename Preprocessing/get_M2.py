...
def main():
    ...
    pre_data_file = 'data/data2/Pre_data2_o' + args[1] + '.txt'
    ...
    output_file = 'data/data2_o' + args[1] + '_' + args[2] + '.txt'
    ...
    re_data = rewrite_data_mat(
        data_mat, dictionary, temp_dictionary, number_of_document)
    ...
    temp_dict_file = 'data/dictionary/data2_o' + \
            args[1] + '_' + args[2] + '.txt'
